...
import AccountManagementAdmin from '../components/dashboard/AccountManagementAdmin';
import DeviceManagementPage from '../components/dashboard/DeviceManagementPage';
...
export default function DashboardPage() {
    ...
    // Samakan menu admin dan user, hilangkan Koneksi & QR
    const baseMenuItems = ['Manajemen Perangkat', 'Kirim Pesan', 'History Pesan'];
            ...
            <div className="bg-slate-900 text-gray-200 min-h-screen">
                ...
                <div className="relative min-h-screen lg:flex">
                    ...
                    <main className="flex-1 p-6 md:p-10">
                        ...
                        {/* ConnectionPage dihapus untuk user biasa, scan QR hanya lewat DeviceManagementPage */}
